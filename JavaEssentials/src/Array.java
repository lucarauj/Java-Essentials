...
public class Array {
    public static void main(String[] args) {
        ...
        String[] treinamento = {"treinamento", "descomplicando", "java", "e", "spring"};
        String[] treinamentoNome = Arrays.copyOfRange(treinamento, 2, 5);
        ...
        String[] arrayCom2 = Arrays.copyOf(treinamentoNome,1);
        List<String> arrayCom2List = List.of(arrayCom2);
        System.out.println("***********************");
        arrayCom2List.forEach(System.out::println);

        //preenchendo um array | itens iguais - fill
